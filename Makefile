...
CC = mingw32-gcc
CFLAGS = -Wall -fPIC -std=gnu11 -pedantic -Wno-unused-result -O3
LIBS = -lm
...
lib: obj
	...
	ar csr $(LIB_DIR)\libdisf.lib $(ALL_OBJS)
...
octave: lib
	octave --no-gui --eval "mex $(MEX_DIR)\DISF_mex.c -I$(INCLUDE_DIR) -L$(LIB_DIR) -ldisf --mex -o $(MEX_DIR)\DISF_Superpixels.mex; exit;" ;
	mv DISF_mex.o $(MEX_DIR); 

matlab: lib
	matlab -nosplash -nodesktop -nojvm -r "mex $(MEX_DIR)\DISF_mex.c -I$(INCLUDE_DIR) -L$(LIB_DIR) -O -ldisf -outdir $(MEX_DIR) -output DISF_Superpixels.mex; exit;" ;
