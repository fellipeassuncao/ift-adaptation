...
bool insertIntListAt(IntList **list, int elem, int label, int index)
{
    ...
    new_cell = createIntCell(elem, label);
...
inline bool insertIntListHead(IntList **list, int label, int elem)
{    
    return insertIntListAt(list, elem, label, 0);
}

inline bool insertIntListTail(IntList **list, int label, int elem)
{
    if(isIntListEmpty(*list))
        return insertIntListAt(list, elem, label, 0);
    else
        return insertIntListAt(list, elem, label, (*list)->size);   
}
